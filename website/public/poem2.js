...
const msgs = [
    ...
    // { uBrightness: 0.1, uColor: 0, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.1, uColorTilt: [0, 3, 5, 0] },
    // dd,
    // { uBrightness: 0.2, uColor: 0, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.1 },
    // 'THE END OF FASCISM', dd,
    // d,
    // { uBrightness: 0.3, uColor: 0, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.1 },
    // 'LOOKS LIKE', dd,
    // d,
    // { uBrightness: 0.4, uColor: 0, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.1 },
    // 'CENTURIES OF QUEERS', dd,
    // d,
    // { uBrightness: 0.5, uColor: 0.5, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.1 },
    // 'DANCING ON THE GRAVE OF', dd,
    // d,
    // { uBrightness: 0.8, uColor: 0.5, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.1 },
    // "1. CAPITALISM", dd,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.1 },
    // "2. THE STATE", dd,
    // d,
    // "3. COLONIALISM", dd,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.2 },
    // "4. NAZIS", dd,
    // d,
    // "5. RACISM", dd,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 1, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.3, uColorTilt: [0, 3, 5, 0] },
    // "6. OPPRESSION", dd,
    // ddd,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 2, uRotateSpeed: 0, uForwardSpeed: 1.0, uDetail: 0.5, uColorTilt: [0, 3, 5, 0] },
    // "IT WILL BE A GRAND PARTY", dd,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 2, uRotateSpeed: 0, uForwardSpeed: 1.5, uDetail: 0.5, uColorTilt: [1, 0, 1, 0] },
    // "EVEN GRANDER THAN\nMARDI GRAS", dd,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 2, uRotateSpeed: -.5, uForwardSpeed: 1.5, uDetail: 0.6, uColorTilt: [1, 2, 3, 0] },
    // "& THERE WILL BE", d,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 2, uRotateSpeed: -.5, uForwardSpeed: 1.5, uDetail: 0.6, uColorTilt: [1, 2, 3, 0] },
    ...
    // "B/C THERE WILL BE", d,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 1, uRotateSpeed: -.5, uForwardSpeed: 2.0, uDetail: 0.6, uColorTilt: [3, 1, 5, 0] },
    // "NO NEED TO WORK", dd,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 2, uRotateSpeed: -.5, uForwardSpeed: 2.0, uDetail: 0.7, uColorTilt: [3, 1, 5, 0] },
    // "& THERE WILL BE", d,
    // d,
    // { uBrightness: 1, uColor: 1, uColorSpeed: 5, uRotateSpeed: -.5, uForwardSpeed: 2.0, uDetail: 0.7, uColorTilt: [3, 1, 5, 0] },
    // "SUCH A\nREVELATORY PALLOR", dd,
    // d,
    // "TO THE WHOLE THING", d,
    // d,
    // { uBrightness: 1, uColor: 1.5, uColorSpeed: 2, uRotateSpeed: -.5, uForwardSpeed: 2.0, uDetail: 0.7, uColorTilt: [3, 1, 5, 0] },
    // "THE PHOTOS WILL BE", d,
    // d,
    // { uBrightness: 1, uColor: 1.5, uColorSpeed: 2, uRotateSpeed: -.05, uForwardSpeed: 0, uDetail: 1.8, uColorTilt: [3, 1, 5, 0] },
    // "EXQUISITE", dd,
    // d,
    // { uBrightness: 1, uColor: 1.5, uColorSpeed: 2, uRotateSpeed: 0, uForwardSpeed: 1, uDetail: 1.0, uColorTilt: [3, 1, 5, 0] },
    // "& THE LIBATIONS\n& SNACKS", d,
    // d,
    // "FUCKING DELICIOUS", dd,
    // d,
    // { uBrightness: 1, uColor: 1.5, uColorSpeed: 2, uRotateSpeed: 0, uForwardSpeed: 1, uDetail: 0.8, uColorTilt: [3, 1, 5, 0] },
    // "THERE WILL BE A", d,
    // d,
    // "GIANT DANCE PARTY", d,
    // d,
    ...
    "& IT WILL BE AT\nTHE STUD", d,
    d,
    { uBrightness: 1, uColor: 1.5, uColorSpeed: 2, uRotateSpeed: 0, uForwardSpeed: 1.5, uDetail: 0.5, uColorTilt: [3, 1, 5, 0] },
